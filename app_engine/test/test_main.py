...
import main
from main import WSGIAppHandler, list_application
...
class TestHelper(unittest.TestCase):
    ...
    def setUp(self):
        self.app = TestApp(WSGIAppHandler(list_application,
...
class SimpleTestMixin(TestMixin):
    ...
    def test_absent_redirect(self):
        ...
        self.assertTrue(
            'Houps: 404 for http://example.com/a_hooks.php' in response)
    ...
    def test_unhallowed_method(self):
        ...
        self.assertEqual(
            '405 Method Not Allowed', response.status)
    ...
    def test_passing_of_post_parameter(self):
        ...
        self.assert_a_hooks_ok(
            self.app.post('/request_url', params={"foo": "bar"}))
...
class SimpleTestPOST(TestHelper, SimpleTestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({'method': 'POST'})
...
class SimpleTestGET(TestHelper, SimpleTestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({'method': 'GET'})
...
class SimpleTestRemoveParam(TestHelper, TestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({'remove': ['sup1', 'sup2', 'sup3']})
...
class SimpleTestOnlyParam(TestHelper, TestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({'only': ['only1', 'only2', 'only3']})
...
class SimpleTestDefaultParam(TestHelper, TestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({'default': {"def1": "val_def1",
                                                  "def2": "val_def2"}})
...
class SimpleTestSetParam(TestHelper, TestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({'set': {"set1": "val_set1",
                                              "set2": "val_set2"}})
...
class OrderTestRemoveOnlyParam(TestHelper, TestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({'remove': ['only_sup1', 'sup2', 'sup3'],
    ...
    def test_forward_existing_param(self):
        ...
        """
        self.assert_transform(req={"only2": "val_only2"},
                              fwd={"only2": "val_only2"})
...
class OrderTestDefaultRemoveOnlyParam(TestHelper, TestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({
            'default': {"def_remove1": "val_def_remove1",
...
class OrderTestSetRemoveOnlyParam(TestHelper, TestMixin):
    ...
    def get_config(self):
        return self.get_forwards_mix({
            'set': {"set_remove1": "val_set_remove1",
